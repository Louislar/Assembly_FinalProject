...
del week14.lst	REM week14可以替換成.asm檔的檔名
del week14.obj
del week14.ilk
del week14.pdb
del week14.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:week14.exe week14.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
